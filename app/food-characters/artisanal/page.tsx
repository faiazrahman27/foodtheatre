...
const artisanalAccentColor = artisanalCategory?.accentColor ?? "var(--ft-viola)";
const artisanalAccentSoftColor =
    ...
    <section className="relative isolate overflow-hidden bg-white py-16 sm:py-24 lg:py-28">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div
          ...
          style={{ backgroundColor: artisanalAccentSoftColor }}
        />
          ...
          <Reveal delay={0.06}>
            <div className="min-w-0">
              ...
              <p
                ...
                style={{ borderColor: artisanalAccentColor }}
              >
          ...
          <Reveal delay={0.12}>
            <div className="relative mx-auto w-full max-w-[390px] lg:mx-0">
              ...
              <div
                ...
                style={{ backgroundColor: artisanalAccentColor }}
              />
  ...
  return (
    <section className="relative isolate overflow-hidden bg-white py-16 sm:py-24">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          className="absolute bottom-[-12rem] left-[-8rem] h-[30rem] w-[30rem] rounded-full blur-3xl"
          style={{ backgroundColor: artisanalAccentSoftColor }}
        />
      </div>
